...
const Post = ({ post, posts, setPosts, setFriendsProfile, images }) => {
  ...
  useEffect(() => {
    axios
      .get("https://dummyapi.online/api/social-profiles")
      .then((response) => {
  ...
  console.log("allllllllllllllllllllll", allPosts);
            ...
            {socialIcons && (
              <div className="social-buttons">
                {allPosts.map((post, index) => (
                  <a
                    key={index}
                    href={post.coverPhoto}
                    target="_blank"
                    className="social-margin"
                  >
                    {/* You can adjust the className and icon based on your design */}
